...
class PController(Node):
    def __init__(self):
        super().__init__('p_controller_ai_khieow')
        ...
        self.status_pub = self.create_publisher(String, '/mission_status/ai_khieow', 10)
        self.pub = self.create_publisher(Twist, '/Ai_Khieow/cmd_vel', 10)
        self.create_subscription(PoseStamped, '/Ai_Khieow/goal_pose', self.goal_cb, 10)
        self.create_subscription(Odometry, '/Ai_Khieow/odom', self.odom_cb, 10)
